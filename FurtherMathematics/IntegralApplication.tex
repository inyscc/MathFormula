...
\begin{spacing}{\hangju}
    ...
    \noindent $\displaystyle \mbox{平行截面面积已知的立体体积}\colon V = \int_{a}^{b}{S(x)\mathrm{d}x}$

    \noindent $\displaystyle \mbox{总路程}\colon S = \int_{t_1}^{t_2}{v(t)\mathrm{d}x}$

    \noindent $\displaystyle \mbox{变力沿直线做功}\colon W = \int_{a}^{b}{F(x)\mathrm{d}x}$

    \noindent $\displaystyle \mbox{提取物体做功}\colon W = \rho g\int_{a}^{b}{sA(x)\mathrm{d}x}$

    \noindent $\displaystyle \mbox{静水压力}\colon P = \int_{a}^{b}{\rho gx\cdot[f(x) - h(x)]\mathrm{d}x}$

    \noindent $\displaystyle \mbox{细杆质心}\colon \bar{x} = \frac{\int_{a}^{b}{x\rho(x)\mathrm{d}x}}{\int_{a}^{b}{\rho(x)\mathrm{d}x}}$
\end{spacing}
